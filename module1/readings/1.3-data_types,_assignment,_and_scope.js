 ...
 * MDN (see link #1 below).  Stop when you get to the literals section.
 * 
...
var adlib = function(animal, )

module.exports.nowYouTry = function() {
    // set some variables before running the "adlib" function.
    
    // set animal = 'horse'
    // set place = 'barn'
    // set preposition = 'over'
    // set action = 'jumped'
    console.log(adlib(animal, action, preposition, place));
...
// uncomment the following line and run "node ./1.3-data_types,_assignment,_and_scope.js"
