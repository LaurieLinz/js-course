 ...
 * 
 * Please learn more about the Math library within JavaScript by reading the 
 * link listed.
 * 
...
/**
 * @param {Number} a Is the length of side 1.
 * @param {Number} b Is the length of side 2.
 * @returns {Number} The length of some right triangle hypotenuse, c.
 */
module.exports.nowYouTry = function(a, b) {
    // make Pythagorus proud, recall that a^2 * b^2 == c^2.
    // use the Math.pow function to make this happen!
    // Math.pow(4, 2) would return 4 to the 2nd power.
}
// uncomment the following line and run "node ./1.4-arithmetic.js"
